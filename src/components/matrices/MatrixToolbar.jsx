...
const MatrixToolbar = ({ onSizeSelect, onImport, onExport, onReset, onExportResult }) => {
    return (
        <div className='flex flex-wrap justify-center lg:justify-start space-x-2 space-y-2 lg:space-y-0 p-4 shadow-md bg-white dark:bg-dark-foreground '>
            ...
            <button onClick={onSizeSelect} className='flex flex-col lg:flex-row items-center justify-center space-x-0 lg:space-x-2 bg-primary dark:bg-secondary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-2 lg:p-4 rounded-md'>
            ...
            <button onClick={onExport} className='flex flex-col lg:flex-row items-center justify-center space-x-0 lg:space-x-2 bg-primary dark:bg-secondary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-2 lg:p-4 rounded-md'>
            ...
            <button onClick={onReset} className='flex flex-col lg:flex-row items-center justify-center space-x-0 lg:space-x-2 bg-primary dark:bg-secondary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-2 lg:p-4 rounded-md'>
            ...
            <button onClick={onExportResult} className='flex flex-col lg:flex-row items-center justify-center space-x-0 lg:space-x-2 bg-primary dark:bg-secondary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-2 lg:p-4 rounded-md'>
