...
const MethodButtons = () => {
    const { solveGaussJordan } = useMatrix();

    return (
        <div className="flex flex-col items-center lg:items-start space-y-4 p-6 rounded-lg shadow-lg bg-white dark:bg-dark-foreground w-full">
            <Button
                onClick={solveGaussJordan}
                className='w-full flex items-center justify-start space-x-4 bg-primary dark:bg-secondary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-4 rounded-md'
            >
                <img src={gaussJordanIcon} alt="Gauss-Jordan" className='w-12 h-12' />
                <span>Gauss-Jordan</span>
            </Button>
            <Button
                onClick={() => alert('Determinante no implementado')}
                className='flex items-center justify-center lg:justify-start space-x-4 bg-primary dark:bg-secondary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-2 lg:p-4 rounded-md'
            >
            ...
            <Button
                onClick={() => alert('Inversa no implementado')}
                className='flex items-center justify-center lg:justify-start space-x-4 bg-primary dark:bg-secondary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-2 lg:p-4 rounded-md'
            >
