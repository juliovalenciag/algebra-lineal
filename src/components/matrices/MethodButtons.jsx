    ...
    return (
        <div className="flex flex-row lg:flex-col items-center justify-center lg:justify-start space-x-4 lg:space-x-0 lg:space-y-4 p-6 rounded-lg shadow-lg bg-white dark:bg-dark-foreground">
            <Button
                ...
                className='flex items-center justify-center lg:justify-start space-x-0 lg:space-x-4 bg-primary hover:bg-primary-dark dark:hover:bg-secondary-dark text-white p-2 lg:p-4 rounded-md w-full max-w-xs'
            >
